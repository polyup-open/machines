...
export function getMachineLanguages(machineStrings : StringDict, chipStringses : StringDict[]) : string[]
{
...
export function getSystemTags(machineStrings : StringDict, chipStringses : StringDict[], machineVersion : number)
{
